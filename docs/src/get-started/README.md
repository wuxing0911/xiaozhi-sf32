...
```powershell
./sftool.exe -p COM11 -c SF32LB52 write_flash bootloader.bin@0x12208000 ftab.bin@0x12000000 ER_IROM2.bin@0x12AE0000 ER_IROM3.bin@0x12460000 ER_IROM1.bin@0x12218000
```
